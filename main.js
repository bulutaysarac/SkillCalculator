...
const drawSkillBoxes = () => {
    for (let i = 0; i < skills.length; i++) {
        ...
        skillBoxBottomContainer.append(skillPointElement);
        skillBoxBottomContainer.append(skillSeperatorElement);
        skillBoxBottomContainer.append(skillMaxPointElement);
